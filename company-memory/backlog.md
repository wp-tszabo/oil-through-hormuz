...
| Scaffold static site structure + GitHub Pages deploy | Build | Done — skeleton is at `site/`, repo is public, GitHub Pages is enabled (Actions-based build, auto-deploys on push to `site/**`), live at https://wp-tszabo.github.io/oil-through-hormuz/ (placeholder content only so far — see decisions-log.md, 2026-09-16). |
